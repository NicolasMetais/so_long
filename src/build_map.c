...
/*   Updated: 2024/12/10 18:36:14 by nmetais          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	insert_map_img(t_game *game, size_t x, size_t y, char **gameboard)
{
	...
	if (type == '0')
		mlx_put_image_to_window(game->mlx, game->win,
			game->ground->ground_img, x * 32, y * 32);
	else if (type == '1')
		mlx_put_image_to_window(game->mlx, game->win,
	...
	{
		coin_transparency(game->ground, game->collect_img, y, x);
		mlx_put_image_to_window(game->mlx, game->win,
			game->ground->ground_img, x * 32, y * 32);
	}
		/*mlx_put_image_to_window(game->mlx, game->win,
			game->collect_img->Cregular_img, x * 32, y * 32);*/
}
...
void	open_img(t_game *game)
{
	...
	game->ground->ground_img = mlx_xpm_file_to_image(game->mlx,
			"GameSprites/Ground.xpm", &width, &len);
	game->collect_img->Cregular_img = mlx_xpm_file_to_image(game->mlx,
			"GameSprites/Coin.xpm", &width, &len);
	game->player->img = mlx_xpm_file_to_image(game->mlx,
			"GameSprites/Charac.xpm", &width, &len);
	game->exit->img = mlx_xpm_file_to_image(game->mlx,
			"GameSprites/Exit.xpm", &width, &len);
	if (!game->wall_img->side_img || game->ground->ground_img
		|| game->collect_img->Cregular_img || game->player->img
		|| game->exit->img)
		return ;
}
